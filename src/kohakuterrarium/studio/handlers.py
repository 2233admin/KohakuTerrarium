"""Command dispatch and handler functions for kt studio."""
...
def handle_studio_command(args: argparse.Namespace) -> int:
    ...
    match args.studio_command:
        ...
        case "cost":
            from kohakuterrarium.studio.cost import handle_cost_command

            return handle_cost_command(args)
        case "record":
            from kohakuterrarium.studio.record import handle_record_command

            return handle_record_command(args)
        case "replay":
            from kohakuterrarium.studio.record import handle_replay_command

            return handle_replay_command(args)
        case "compare":
            from kohakuterrarium.studio.compare import handle_compare_command

            return handle_compare_command(args)
        case "completion":
            from kohakuterrarium.studio.completion import handle_completion_command

            return handle_completion_command(args)
        case "diff":
            from kohakuterrarium.studio.profiles import handle_diff_command
...
def _resolve_profile(
    ...
    """Resolve a profile name from args or active_profile."""
